...
public class ModItems {
    public static final Item KHINKALI=registerItem("khinkali",new Item(new Item.Settings().registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of(Geocraft.MOD_ID,"khinkali")))));
